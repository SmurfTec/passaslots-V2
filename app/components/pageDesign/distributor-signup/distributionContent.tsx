  ...
  return (
    <div style={{background: '#150B2E'}}>
      <BackgroundImage style={{backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom right'}} bgsz='auto' src="/images/pages/distribution/dices.png">
        <Container pt={100} pb={50} fluid ml={matches ? 5 : 90} mr={matches ? 5 : 69}>
          <Grid align="center">
            <Grid.Col sm={12}>
          ...
          <Grid pt={100} align='center' grow gutterSm={100}>
            <Grid.Col sm={6} pt={80}>
              <Text maw={575} color="#FFFFFF" className="font-[400] leading-[38px] tracking-[0.005em] text-[20px]" opacity={0.8}>
            ...
            <Grid.Col sm={6} pt={80}>
              <List styles={{
                ...
                <List.Item>
                  <Text maw={566} color='#FFFFFF' className='font-[400] leading-[38px] tracking-[0.0125em] text-[20px]' opacity={0.8}>
          ...
          <Grid pt={100} align='center'>
            <Grid.Col sm={12}>
              <Text maw={1185} color='#FFB800' mb={30} className='font-[400] leading-[25px] text-[13px]'>
