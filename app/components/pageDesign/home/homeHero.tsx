import { BackgroundImage, Button, Grid, Group, Image, Text, Title, createStyles, Modal, Popover, Center, Container } from '@mantine/core';
...
export function HomeHero() {
  ...
  return (
    ...
    style={{
      ...
      {/* <Container fluid> */}
        <Image className='absolute center top-1 opacity-80' width={"100%"} height={693} src="/images/header/backgroundImage.png" alt='image' />
        <Group align='center' position='apart'>
          <Grid m={0} align="center">
            <Grid.Col order={2} orderMd={2} m={0} md={11} className='relative text-center items-center mt-[190px]'>
              <Center w={'100%'}>
                <Carousel  styles={{
                  indicator: {
                    width: "22px",
                ...
                withIndicators align='center' loop images={images} delay={5000} />
              </Center>
              {/* <Image className='ml-[421px]' width={598} height={598} src="/images/pages/home/HomeFirstImage.png" alt='image' /> */}
              <Title align='center' color={'#FFB800'} mt={27} className="font-[900] text-center uppercase" order={1}>
                Pasa SLOTS
              </Title>
              <Title align='center' color={'#ffffff'} mt={13} className="font-[700] text-center uppercase" size={'md'} order={2}>
            ...
            {!matches ? (
              <Group align={'center'} className=''>
                {/* <Grid.Col> */}
                  ...
                  >
                    <Popover.Target>
                      <Button className='absolute translate-y-1/2' onClick={() => setSideButtons(!sideButtons)} h={70} w={70} 
