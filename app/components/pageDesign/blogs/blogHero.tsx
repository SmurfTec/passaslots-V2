...
export function BlogHero() {
  ...
  return (
    <div onClick={closesideMenu} className={classes.backdrop}>
      ...
      >
        <Container fluid pl={matches ? 5 : 90} pr={matches ? 5 : 69} pt={matches ? 50 : 100}>
          ...
          <Stack pt={100} justify="center">
            ...
            <Image maw={500} mah={303} className="mx-auto my-auto" src="/images/pages/blogs/bloghero.png" alt="image" />
          </Stack>
        </Container>
      </BackgroundImage>
      {!matches ? (
