        ...
        <Container fluid ml={90} mr={69} py={100} className="sm:mb-[auto] relative">
          ...
          <Stack pt={400} h={matches ? "40vh" : "80vh"} justify='center'>
            <div className="text-center">
              <Title className="uppercase font-[900] text-center text-[#FFB800]" order={3} style={{textShadow: '0px 4px 33px #016BE6', lineHeight: '38px'}}>
                Blogs
              </Title>
              ...
              style={{
                ...
                READ MORE ABOUT THE<br/> PASA SLOTS COMMUNITY
              </Title>
            </div>
            <Image width="auto" height="auto" className="mx-auto my-auto pt-[33px]" src="/images/pages/blogs/bloghero.png" alt="image" />
          </Stack>
        </Container>
      </BackgroundImage>
    </div>
