...
export function HiwStage() {
  ...
  return (
    <div style={{background: 'radial-gradient(58.07% 58.07% at 50% 50%, rgba(27, 16, 59, 0) 0%, #1A0F39 100%)'}}>
      <BackgroundImage 
      style={{
        ...
        minHeight: '315vh',
      }} className='' src="/images/pages/hiw/pasagamming.png" bgsz='auto' >
        <Container className="mt-24 sm:mt-0" fluid ml={90} mr={69}>
          <Grid justify='center' align='center'>
            <Grid.Col sm={12}>
              <Grid justify='center' align='center'>
                <Grid.Col sm={12}>
                  <Title mt={109} color='white' className="uppercase text-center text-[48px] leading-[56px] tracking-[-0.015em] font-[700] mb-0">
                    JOIN
                    <span className="text-[#50A1FF]"> PASA </span>
                    GAMING
                  </Title>
                  <Text color="#FFFFFF" className="uppercase text-center text-[20px] tracking-[0.0125em] leading-[21px] font-[500]" mt={23}>
