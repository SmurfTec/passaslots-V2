...
export function PDHero() {
  ...
  return (
    <div onClick={closesideMenu} style={{
      ...
      <Container fluid pl={matches? 5 : 90} pr={matches? 5 : 69} pt={matches ? 50 : 50} pb={matches ? 50 : 50}>
        <Grid justify='center' align='center'>
          <Grid.Col sm={12}>
            <div className='text-center'>
              <Title mt={100} color='white' className='uppercase md:!text-[44px] sm:!text-[24px] xs:!text-[24px] font-[900] md:!leading-[50px] sm:!leading-[25px] xs:!leading-[25px] tracking-[-0.015em] drop-shadow-[0_4px_33px_#016BE6] text-center'>
                Empower Your Organization With
              </Title>
              <Title mt={20} color='#FFB800' className='uppercase md:!text-[84px] sm:!text-[40px] xs:!text-[40px] font-[900] md:!leading-[100px] sm:!leading-[56px] xs:!leading-[56px] tracking-[-0.015em] text-center'>
                PASA SLOTS
              </Title>
            </div>
          </Grid.Col>
          ...
          <Grid.Col sm={12}>
            <Grid align='center' justify='center' className='text-center'>
              <Image mah={502} maw={425} alt="logo"  className='mx-auto my-auto' src='/images/pages/pasa-for-distributor/lepriconhero.png' />
            </Grid>
          </Grid.Col>
        </Grid>
      </Container>
