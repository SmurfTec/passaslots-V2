        ...
        <Grid pl={90} pr={69}>
          <Grid.Col xs={6}>
            ...
            <Text my={37} className='text-[20px] font-[400] leading-[38px] tracking-[0.0125em]' color='white'>
              ...
              home-based business allows you to turn your passions into a high-<br/>
              income career.
            </Text>
          </Grid.Col>
          <Grid.Col xs={6}>
            <Image height='auto' width='auto' src="/images/pages/pasa-for-distributor/awakenBalance.png" alt="awakenBalance" />
          </Grid.Col>
        </Grid>
      </BackgroundImage>
      <div style={{
          ...
          <Grid pt={150} pb={150} pl={90} pr={69} m={0} align='center' justify='center' gutterSm={50}>
            <Grid.Col xs={12} sm={12}>
              <div className="text-center">
                <Title className='uppercase text-[48px] text-center font-[700] leading-[51px] tracking-[0.0125em]' color='white'>
                  Power of <span className="text-[#50A1FF]">Technology</span>
                </Title>
                <Text mt={37} className='text-[20px] font-[400] text-center leading-[38px] tracking-[0.0125em]' color='white'>
                  With the rise of technology and the growing gig economy, there's never been a better time to start your<br/> 
                  ...
                  goodbye to the daily commute and say hello to the comfort and flexibility of working from your own<br/> 
                  home. You'll be in control of your schedule. So why wait? Unleash your entrepreneurial spirit and{' '}
                  <span className="font-[700]">start<br/> your home-based business</span> today!
                </Text>
                <Button
                styles={{
                  root: {
