          ...
          <Grid.Col sm={12}>
            ...
            <Grid justify='center'>
              <Group align='center' className='flex flex-nowrap' pb={15}>
                ...
                <Text 
                style={{border: '4px solid #016BE6', borderRadius: '50px', filter: 'drop-shadow(0px 11px 32px #016BE6)', padding: '15px 20px 15px 20px'}}
                className="xl:w-[1145px] lg:w-[900px] md:w-[650px] sm:w-[250px] xs:w-[200px] font-[700] text-center text-[18px] leading-[34px] tracking-[0.0125em]">
