        ...
        <Grid align='center' justify='center'>
          <Grid.Col sm={12}>
            <div className='flex justify-center'>
              <Image height='auto' width='auto' className='mx-auto my-auto' src="/images/pages/game/egyptian.png" alt='egyptian'  />
            </div>
            ...
            <Grid justify='center'>
              <Group align='center' pb={15}>
                ...
                <Text 
                style={{border: '4px solid #016BE6', borderRadius: '50px', filter: 'drop-shadow(0px 11px 32px #016BE6)', padding: '15px 320px 15px 20px'}}
              ...
              <Group align='center' py={15}>
                ...
                <Text 
                style={{border: '4px solid #016BE6', borderRadius: '50px', filter: 'drop-shadow(0px 11px 32px #016BE6)', padding: '15px 350px 15px 20px'}}
                className="font-[700] text-center text-[18px] leading-[34px] tracking-[0.0125em]">
              ...
              <Group align='center' py={15}>
                ...
                <Text 
                style={{border: '4px solid #016BE6', borderRadius: '50px', filter: 'drop-shadow(0px 11px 32px #016BE6)', padding: '15px 280px 15px 20px'}}
                className="font-[700] text-center text-[18px] leading-[34px] tracking-[0.0125em]">
