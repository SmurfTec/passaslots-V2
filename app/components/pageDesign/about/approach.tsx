...
export function Approach () {
    return <div style={{background: 'radial-gradient(124.84% 124.84% at 50% 50%, rgba(26, 14, 55, 0.76) 0%, #1A0E37 100%), url(image.png)'}}>
        <BackgroundImage
        style={{
            ...
            minHeight: '108vh',
          }} className='' src="/images/pages/about/approachbg.png" bgsz='auto' >
            <Container fluid ml={90} mr={69} py={100}>
                ...
                <Text mt={25} className='text-[#ffffff] font-[400] text-center text-[24px] leading-[28px] tracking-[0.0125em]'>
                    Let’s create the next generation of online game room platform
                </Text>
                <Grid mt={100} justify="center" align="center" className="grid grid-items-center grid-rows-2 grid-flow-col gap-[80px]">
