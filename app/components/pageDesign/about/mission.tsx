...
export function Mission() {
  return (
    <div style={{
      ...
      <Container size={1200} py={100} className='pt-50 md:pt-0'>
        {/* <div style={{
          ...
          {/* 1st Row */}
          <Grid className="space-y-24" grow gutter={'xl'} py={20}>
            <Grid.Col className="relative mt-16 md:mt-0" xs={12} sm={4} orderSm={1} order={1} pt={30} mb={50}>
              <div className="absolute text-center sm:text-left mt-[15px] ml-[100px]">
                <Title color="white" size={32} order={2}>
                  OUR MISSION
                </Title>
                <Text mt={15} color="white" className="font-[300] tracking-[0.005em]" opacity={0.8} size="sm" maw={300}>
            ...
            {/* 2nd Row */}
            <Grid.Col className="relative ml-[250px]"  xs={12} sm={3} orderSm={4} order={3} pt={30}>
            ...
            {/* 3rd Row */}
            <Grid.Col className="relative" xs={12} sm={3} orderSm={5} order={5} pt={30}>
              <div className="absolute text-center md:text-left ml-[100px]">
                <Title color="white" size={32} order={2}>
                  OUR COMMITMENT
                </Title>
                <Text mt={15} color="white" className="font-[300] tracking-[0.005em]" opacity={0.8} size="sm" maw={300}>
